     ...
     <>
        <ScrollView>
            ...
            <Text style={{fontSize:20, textAlign:"justify", marginTop: "30%", marginBottom:"30%", marginHorizontal:'3%'}}>
                Você aqui está dizendo para o E-mail
                para que nós (Pirambu Food) possamos entrar
                em contato com você quando você tiver problemas.
                Estamos aqui para te ajudar, então informe um 
                E-mail que você tem acesso.
