     ...
     <>
        <ScrollView>
            ...
            <Text style={{fontSize:20, textAlign:"justify", marginTop: "30%", marginBottom:"30%", marginHorizontal:'3%'}}>
                ...
                por que número o restaurante pode ligar para entregar sua comida. 
                Recomendamos que você escolha seu número de telefone atual por motivos
                de organização do restaurante e evitar possíveis problemas.
            </Text>
